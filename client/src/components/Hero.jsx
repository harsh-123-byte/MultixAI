// Isme humara home page pe navbar ke alawa jo hero section hota hai use display karana hai.
...
const Hero = () => {
    ...
    const navigate = useNavigate() // This is useNavigate Hook.

  return (
    <div className='px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>

        <div className='text-center mb-6'>
            <h1 className='text-3xl sm:text-5xl md:text-6xl 2xl:text-7xl font-semibold mx-auto leading-[1.2]'><span className='text-primary'>Create</span> or <span className='text-primary'>Generate</span> amazing content <br/> with <span className='text-primary'>AI tools</span></h1>
