...
const RemoveObject = () => {
  ...
  const [object, setObject] = useState('') // hume object ka bhi to detail chahiye jise hume remove karna hai.

  // ye to saare pages me common hai.
    ...
    const onSubmitHandler = async (e)=>{
          ...
          try {
            ...
            if(object.split(' ').length > 1){
              return toast('Please enter only one object name') // ek hi object remove karna hai.
            }
